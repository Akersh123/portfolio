...
class ProjectPortfolio extends Component
{
    ...
    public function mount()
    {
        $this->projects = [
            ...
            ['id' => 1, 'title' => 'Portfolio Website', 'desc' => 'Animated portfolio using GSAP and Tailwind', 'tags' => ['GSAP', 'Tailwind']],
            ['id' => 2, 'title' => 'Lead Management System', 'desc' => 'Lead Management System', 'tags' => ['Laravel', 'Bootstrap']],
        ];
    }
