        ...
        <div class="flex flex-col md:flex-row md:items-center md:gap-12">
            ...
            <div class="w-full md:w-1/2 mb-6 md:mb-0 order-1 md:order-2">
                <figure class="w-full rounded-xl overflow-hidden shadow-lg">
                    <img src="{{ asset($image) }}" alt="About image" loading="lazy"
            ...
            <div class="w-full md:w-1/2 order-2 md:order-1">
                <div class="prose prose-lg max-w-none text-block">
                    <div id="about-scroll-wrap">
                        <p id="about-scroll-line" class="text-justify text-base leading-relaxed">
                            {{ $desc }}
                        </p>
                    </div>
                    ...
                    <div class="mt-6">
                        <a href="#projects"
                            class="inline-block px-5 py-2 rounded-full bg-white text-black font-medium shadow hover:shadow-md transition">
                            View Projects
                        </a>
                    </div>
                </div>
